...
public class DiaryItemScanPanel extends JLayeredPane  implements HyperlinkListener {
	...
	public DiaryItemScanPanel(Aritcle aritcle) {
...
//				port.setViewPosition(new Point(0, 50));
		...
		String html;
		try {
			html = new Markdown4jProcessor().process(aritcle.content);
			System.out.println(html);
			html="<head><style type=\"text/css\">body {font-size:14px !important;font-family: \"微软雅黑\";color:#FFFFFF;}</style></head><body>"+html+"</body>";
//			System.out.println(html);
