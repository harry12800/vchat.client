...
public class CatalogItemPanel extends JPanel {
	 ...
	 * @param checked
	 */
	public CatalogItemPanel(int w, int h, final Builder builder) {
		this.w = w;
		this.h = h;
		...
		add(picture);
		add(text);
		text.setText(builder.categoryNode.getFile().getName());
	...
	public static Builder createBuilder(CategoryNode categoryNode, Color backColor) {
